(function () {
  const copy = {
    zh: {
      ...
      listening: "录音中～",
      speechUnsupported: "当前浏览器不支持网页语音识别，可以用系统语音键盘或直接打字。",
    ...
    en: {
      ...
      listening: "Listening...",
      speechUnsupported: "This browser does not support web voice input. Please use the keyboard voice input or type.",
      speechError: "I did not catch that. Please try again.",
